	...
	.star{
		...
		&.star-48{
				.star-item{ 
					...
					&.on{
						@include bg_img('star48_on');
					}
					&.half{
						@include bg_img('star48_half');
					}
					&.off{
		...
		&.star-36{
			.star-item{ 
				...
				&.on{
					@include bg_img('star36_on');
				}
				&.half{
					@include bg_img('star36_half');
				}
				&.off{
		...
		&.star-24{
			.star-item{ 
				...
				&.on{
					@include bg_img('star24_on');
				}
				&.half{
					@include bg_img('star24_half');
				}
				&.off{
